...
#using finite element method for wave number q = q_c = (3/(\beta))^(1/4)
...
vtkfile_u1 = File('q_23_4/height.pvd')
vtkfile_u2 = File('q_23_4/second_derivative.pvd') 
vtkfile_u3 = File('q_23_4/fourth_derivative.pvd')
vtkfile_u4 = File('q_23_4/pressure.pvd')
vtkfile_u5 = File('q_23_4/velocity.pvd')
